...
df = pd.read_csv('error-pointwise-hmm.csv', index_col=False)
...
l,r = ternary_search(5.92, 5.94, 0.000000001, f)
...
plt.title("Distance between observations and matches (HMM)")
plt.grid()
...
plt.savefig("hmm-delta-match-obs-delta.png", dpi=600)
plt.savefig("hmm-delta-match-obs-delta.svg")
