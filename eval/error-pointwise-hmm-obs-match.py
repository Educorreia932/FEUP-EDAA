...
plt.title("Difference between great-circle and shortest-path distance (HMM)")
plt.grid()
...
plt.savefig("hmm-obs-match.png", dpi=600)
plt.savefig("hmm-obs-match.svg")
